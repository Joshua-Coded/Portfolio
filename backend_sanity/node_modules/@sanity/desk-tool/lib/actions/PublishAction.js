...
var PublishAction = props => {
  ...
  var _useDocumentPane = (0, _useDocumentPane2.useDocumentPane)(),
      ...
      documentIsReferenced = _useDocumentPane.documentIsReferenced;
  ...
  var _useState5 = (0, _react.useState)(false),
      ...
      showConfirmPublishReferencedDocument = _useState6[0],
      setShowConfirmPublishReferencedDocument = _useState6[1]; // Deals with edge-case: if a reference is removed while the confirmation box is open, it will close
  ...
  var dialog = {
    type: 'confirm',
    color: 'success',
    confirmButtonIcon: _icons.CheckmarkIcon,
    cancelButtonIcon: _icons.CloseIcon,
    ...
    message: /*#__PURE__*/_react.default.createElement(_ui.Stack, {
      ...
      marginRight: 2
    }, /*#__PURE__*/_react.default.createElement(LinkCircle, null, /*#__PURE__*/_react.default.createElement(_icons.LinkIcon, {
      fontSize: '24'
    }))), /*#__PURE__*/_react.default.createElement(_ui.Heading, {
      size: 1
    }, "Referenced Document")), /*#__PURE__*/_react.default.createElement(_ui.Text, null, "Publishing changes may affect documents that reference this document"))
  };
  return {
...
var LinkCircle = _styledComponents.default.div(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n  border: 1px solid var(--card-shadow-outline-color);\n  border-radius: 50%;\n  width: 24px;\n  height: 24px;\n"])));